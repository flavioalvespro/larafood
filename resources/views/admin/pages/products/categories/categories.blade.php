...
@section('content_header')
    ...
    <h1>Categorias do Produto {{$product->title}} <a href="{{ route('products.categories.available', $product->id) }}" class="btn btn-dark"><i class="fas fa-plus-square"></i> Adicionar Nova Categoria</a></h1>
@stop
